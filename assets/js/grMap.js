...
class GRMap extends HTMLElement {
  ...
  renderMapContainer() {
    ...
    div.setAttribute('style', `height: ${this.height || '67vh'}; max-width: 80vw; margin: 0 auto; display: flex; align-items: center; justify-content: center; border-radius: 10px; z-index: 25;`);
